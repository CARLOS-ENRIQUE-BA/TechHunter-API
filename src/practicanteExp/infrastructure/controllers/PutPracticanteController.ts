...
export class PutPracticanteExpController {
    constructor(readonly putPracticanteExpUseCase: PutPracticanteExpUseCase) { }
    async run(req: Request, res: Response) {
        ...
        try {
            if (filename === undefined) {
                practicanteExp = await this.putPracticanteExpUseCase.run(
                    id,
